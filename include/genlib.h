 ...
 *        applications as fundamental types.基础数据类型
 *
 *    2.  A new set of functions for memory allocation.内存分配的新函数
 *
 *    3.  A function for error handling.错误处理函数一枚
 *
 *    4.  A repeat statement for loops with interior exits.带有内部中断的循环语句
 */
 ...
 * Declaring it as a string emphasizes this atomicity.增强可读性
 */
 ...
 * to teach all of CS1 without exposing any pointers.文件流
 */
 ...
 * sentinel哨兵 to indicate an undefined pointer value.  In many
