 ...
 * find out the obj, renturn NULL otherwise.搜索
 */
 ...
 * ----------------------------
 * This function inserts the data value after the nodeptr node of the linked
 ...
 * ------------------------------
 * This function traverses穿越 the linked list, and process the node value obj using
 ...
 * ------------------------------
 * This function return the pointer of the index-th node of the linked list.第i个元素
 */
 ...
 * ------------------------------
 * This function return the pointer of the next node of the node nodeptr.传入指针的下一个节点
 */
 ...
 * ------------------------------
 * This function return the dataptr of the node nodeptr points to.取内容
 */
